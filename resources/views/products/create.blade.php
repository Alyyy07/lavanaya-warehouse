<x-app-layout>
    ...
    <div class="card-app mx-auto p-0 overflow-hidden max-w-4xl">
        <div class="bg-primary px-8 py-4 flex justify-between items-center text-white">
            <h2 class="text-xs font-bold tracking-widest">Registrasi Produk</h2>
        </div>
        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="p-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs font-bold tracking-widest text-slate-500 mb-2">Satuan Unit <span
                                    class="text-red-600">*</span></label>
                            <input type="text" name="unit" class="input-app w-full text-xs font-bold"
                                placeholder="PCS / KG" value="{{ old('unit', 'PCS') }}" required />
                        </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" class="input-app w-full min-h-25 text-xs font-medium py-3"
                            placeholder="Spesifikasi atau catatan khusus mengenai produk ini...">{{ old('description') }}</textarea>
                    </div>
                </div>
            </div>
