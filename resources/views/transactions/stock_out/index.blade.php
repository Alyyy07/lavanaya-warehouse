<x-app-layout>
    @section('header_title', 'Alur Logistik: Barang Keluar')

    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-xl font-black text-secondary tracking-tighter">Logistik Keluar</h1>
            <p class="text-[10px] font-bold text-slate-400 tracking-widest mt-1">Registrasi Pengeluaran Barang
                & Distribusi Unit</p>
        </div>
        <a href="{{ route('transactions.out.create') }}" class="btn-app-primary whitespace-nowrap">
            <i data-lucide="minus-circle" class="h-4 w-4 mr-2"></i>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-slate-50/50">
                        ...
                        <th class="px-8 py-4 text-[11px] font-bold uppercase tracking-widest text-slate-400">Unit
                            Barang</th>
                        <th class="px-8 py-4 text-[11px] font-bold uppercase tracking-widest text-slate-400">Tujuan
                            Distribusi</th>
                        <th
                ...
                <tbody class="divide-y border-border">
                    ...
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-6 py-4">
                            <div class="text-[10px] font-bold text-slate-500">{{ $transaction->destination ??
                                'Distribusi Umum' }}</div>
                        </td>
                        <td class="px-6 py-4 text-center">
                            <div class="inline-flex flex-col items-center">
                                <span class="text-xs font-black text-red-600">-{{ $transaction->quantity }}</span>
